const itActsAsFavoriteRestaurantModel = (favoriteRestaurant) => {
  ...
  it('should be able to search for restaurants', async () => {
    ...
    favoriteRestaurant.searchRestaurants('restaurant a');
    // check if searchRestaurants is called
    // console.log(await favoriteRestaurant.searchRestaurants('restaurant a'));
